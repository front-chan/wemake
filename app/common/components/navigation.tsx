...
export default function Navigation({
  ...
  return (
    <nav className="flex px-20 h-16 items-center justify-between backdrop-blue fixed top-0 left-0 right-0 z-50 bg-background/50">
        ...
        <NavigationMenu>
          <NavigationMenuList>
            {menus.map((menu) => (
              ...
              // <NavigationMenuItem
              //   key={menu.name}
              //   className="select-none rounded-md transition-colors focus:bg-accent hover:bg-accent" // hover 기본적으로 됨
              // >
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="cursor-pointer">
              <Avatar>
                <AvatarImage src="https://github.com/front-chan.png" />
